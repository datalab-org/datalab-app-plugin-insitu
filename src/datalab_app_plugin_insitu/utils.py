...
def setup_paths(
    nmr_folder_path: str, start_at: int, exclude_exp: Optional[List[int]]
...
def _process_data(
    ...
    merged_df = process_echem_data(base_folder, echem_folder_name) if echem_folder_name else None
